...
Larr=np.linspace(1000,10000,10)#np.concatenate([np.linspace(100,1000,10),np.linspace(2000,9000,8)],axis=0)
L=Larr[int(os.environ[\"SLURM_ARRAY_TASK_ID\"])-1]  #Set system size.
paramvals0=LMG.Ham_params(N=L,S=L/2,J=1.,γz=1.0,γy=0.5,Γ=1.)
