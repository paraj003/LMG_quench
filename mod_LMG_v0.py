...
#v0.0 with only single anisotropy parameter γ
import numpy as np
import os
import h5py
...
class Ham_params:
    ...
    def paramstr(self):
        ...
        return'L_'+str(float(self.N))+',S_'+str(float(self.S))+',J_'+str(float(self.J))+',Γ_'+str(float(self.Γ))+',γ_'+str(float(self.γ))
